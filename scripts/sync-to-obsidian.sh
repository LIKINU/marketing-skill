...
**本地工作區**：\`$HOME/Desktop/Marketing-skill/marketing-playbook/\`
...
- **手動同步**：\`cd $HOME/Desktop/Marketing-skill/marketing-playbook && bash scripts/sync-to-obsidian.sh\`
...
| \`references/\` | 打法庫 104 條／方法論手冊 63 個模型／18 個行業案例集／方案寫作指南／多 Agent 分工簡報／**羅森案範式（83 項量化指標）**／三份體檢報告 |
...
| **規範細節** | 本存檔 \`SKILL.md\` |
| **質量標準** | 本存檔 \`references/范本-罗森案范式.md\`（83 項指標） |
| **具體案例** | 本存檔 \`references/cases/\`（18 個行業） |
